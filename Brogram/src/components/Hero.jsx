    ...
    return (
        <>
            ...
            <ul className="rules-list">
                ...
                <div className="rule-item">
                    <p><b>Reps</b></p>
                    <p>Every rep is a pause rep following a <abbr title="2 seconds down - 2 seconds paue - 2 seconds up">2 - 2 - 2 tempo</abbr></p>
                </div>
                <div className="rule-item">
                    <p><b>Weight*</b></p>
            ...
            <p>This trainin gplan uses a structure known as the <b>Bro Splits</b>, and follows this rotation ⬇️</p>
